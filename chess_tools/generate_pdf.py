...
for tag, title, desc in w_attack_themes:
...
for tag, title, desc in w_structural_themes:
    matching = tagged(white_games, tag)
    if matching:
        html += theme_box(title, desc, matching, True)
...
for tag, title, desc in w_threat_themes:
    matching = tagged(white_games, tag)
    if matching:
        html += theme_box(title, desc, matching, True)
...
for tag, title, desc in b_themes:
...
for tag, title, desc in b_opening_themes:
    matching = tagged(black_games, tag)
    if matching:
        html += theme_box(title, desc, matching, False)
